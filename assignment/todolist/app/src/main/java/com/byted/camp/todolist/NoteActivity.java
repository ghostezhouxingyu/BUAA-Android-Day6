...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prioGroup = findViewById(R.id.priority_radio);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int priority = 1;
                if(prioGroup.getCheckedRadioButtonId() == R.id.prio_1)
                    priority = 1;
                else if(prioGroup.getCheckedRadioButtonId() == R.id.prio_2)
                    priority = 2;
                else if(prioGroup.getCheckedRadioButtonId() == R.id.prio_3)
                    priority = 3;
                else
                    Log.e("fordebug", "onClick: wrong priority" );
